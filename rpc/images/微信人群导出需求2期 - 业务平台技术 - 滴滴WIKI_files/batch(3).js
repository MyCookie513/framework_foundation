...
Confluence.Templates.HipChat.Discovery.integrationDialog = function(opt_data, opt_ignored) {
  return '<h2>' + soy.$$escapeHtml('\u8fde\u63a5\u60a8\u7684 Confluence \u7ad9\u70b9\u5230 HipChat') + '</h2><p>' + soy.$$escapeHtml("\u8BBE\u7F6E\u5E76\u53D1\u9001\u901A\u77E5\u5230 Hipchat \u623F\u95F4\u3002") + '</p><br/><button class="aui-button" id="hipchat-integration-discovery-open">' + soy.$$escapeHtml('\u4e0e Hipchat \u6574\u5408') + '</button><a href="#" style="padding-left: 20px" id="hipchat-integration-discovery-dismiss">' + soy.$$escapeHtml('\u4e0d\u662f\u73b0\u5728') + '</a>';
};
if (goog.DEBUG) {
...
Confluence.Templates.HipChat.Presence.chatBar = function(opt_data, opt_ignored) {
  return '<div class="hipchat-chatbar aui-buttons"><button class="aui-button hipchat-chat" title="' + soy.$$escapeHtml('\u65e0\u6cd5\u5f00\u59cb\u804a\u5929\uff0c\u56e0\u4e3a\u6b64\u7528\u6237\u5728 HipChat \u4e2d\u672a\u77e5\u3002') + '" aria-disabled="true"><span><span class="aui-icon aui-icon-small hipchat-icon-chat">' + soy.$$escapeHtml('\u804a\u5929') + '</span></span></button><button class="aui-button hipchat-voice" title="' + soy.$$escapeHtml('\u65e0\u6cd5\u5f00\u59cb\u8bed\u97f3\u901a\u8bdd\uff0c\u56e0\u4e3a\u6b64\u7528\u6237\u5728 HipChat \u4e2d\u672a\u77e5\u3002') + '" aria-disabled="true" data-call-type="voice"><span><span class="aui-icon aui-icon-small hipchat-icon-voice">' + soy.$$escapeHtml('\u8bed\u97f3') + '</span></span></button><button class="aui-button hipchat-video" title="' + soy.$$escapeHtml('\u65e0\u6cd5\u5f00\u59cb\u89c6\u9891\u901a\u8bdd\uff0c\u56e0\u4e3a\u6b64\u7528\u6237\u5728 HipChat \u4e2d\u672a\u77e5\u3002') + '" aria-disabled="true" data-call-type="video"><span><span class="aui-icon aui-icon-small hipchat-icon-video">' + soy.$$escapeHtml('\u89c6\u9891') + '</span></span></button></div>';
};
if (goog.DEBUG) {
...
(function(d){var f=AJS.DarkFeatures.isEnabled("hipchat.chatbar");var a={hipChatCall:function(g,h){if(!g){return}return"hipchat://hipchat.com/user/"+encodeURI(g)+(h?"?call="+encodeURI(h):"")}};var c=AJS.contextPath()+"/rest/hipchat/integration/1.0/users/";var b=function(g){return function(j){var i=d(this);var h=i.attr("data-user-id");var k=i.attr("data-caller-id");if(!k){return}var l=i.attr("data-call-type");if(!g&&l){return}window.location.replace(a.hipChatCall(k,l));AJS.trigger("analyticsEvent",{name:"hipchat.chatbar."+(l||"chat"),data:{userId:h}});j.preventDefault()}};var e=function(g){return function(i){if(!i||!i.presence){return}var j=i.userId;var h=i.hipChatUserId;var k;var m;var l=d(g).find(".hipchat-chatbar .aui-button");l.attr("data-user-id",j);l.attr("data-caller-id",h);l.click(b(i.presence.is_online));if(i.presence.is_online){if(i.presence.show==="xa"||i.presence.show==="away"){k="away";m="\u4e0d\u5728"}else{if(i.presence.show==="dnd"){k="dnd";m="\u8bf7\u52ff\u6253\u6270"}else{k="available";m="\u53ef\u7528"}}l.filter(".hipchat-chat").attr("title","\u4e0e Hipchat \u4e2d\u7684\u8fd9\u4e2a\u7528\u6237\u5f00\u59cb\u804a\u5929\u3002").removeAttr("aria-disabled");l.filter(".hipchat-voice").attr("title","\u5f00\u59cb\u5728 HipChat \u4e2d\u4e0e\u6b64\u7528\u6237\u8bed\u97f3\u901a\u8bdd\u3002").removeAttr("aria-disabled");l.filter(".hipchat-video").attr("title","\u5f00\u59cb\u5728 HipChat \u4e2d\u4e0e\u6b64\u7528\u6237\u89c6\u9891\u901a\u8bdd\u3002").removeAttr("aria-disabled")}else{k="offline";m="\u79bb\u7ebf";l.filter(".hipchat-chat").attr("title","\u4e0e Hipchat \u4e2d\u7684\u8fd9\u4e2a\u7528\u6237\u5f00\u59cb\u804a\u5929\u3002").removeAttr("aria-disabled");l.filter(".hipchat-voice").attr("title","\u65e0\u6cd5\u5f00\u59cb\u8bed\u97f3\u901a\u8bdd\uff0c\u56e0\u4e3a\u6b64\u7528\u6237\u5728 HipChat \u4e2d\u672a\u77e5\u3002");l.filter(".hipchat-video").attr("title","\u65e0\u6cd5\u5f00\u59cb\u89c6\u9891\u901a\u8bdd\uff0c\u56e0\u4e3a\u6b64\u7528\u6237\u5728 HipChat \u4e2d\u672a\u77e5\u3002")}if(i.presence.status){m+=" ("+i.presence.status+")"}d("div.values",g).append(Confluence.Templates.HipChat.Presence.badge({statusCode:k,statusMessage:m}));AJS.trigger("analyticsEvent",{name:"hipchat.presence.user.found",data:{userId:i.userId}})}};d(document).bind("ajaxComplete",function(i,g,h){if(/userinfopopup\.action/.test(h.url)){d.each(d(".vcard"),function(n,p){var m=d(p);var k=m.closest(".contents");var l=k.find(".profile-macro").first();var o=k.find(".actions").first();if(l.hasClass("hipchat-status-applied")||!o.length){return}l.addClass("hipchat-status-applied");if(f){o.addClass("hipchat-chatbar-support");o.append(Confluence.Templates.HipChat.Presence.chatBar());o.find(".ajs-menu-bar").addClass("aui-buttons");o.find(".ajs-button > a").addClass("aui-button");o.find(".user-popup-more").addClass("aui-button");o.find(".user-popup-more > span > span").addClass("aui-icon aui-icon-small aui-iconfont-more").text("")}var q=d(".userLogoLink",m).attr("data-username");var j=c+encodeURIComponent(q);d.getJSON(j,e(k)).fail(function(t){if(t.status===404){try{var r=JSON.parse(t.responseText);if(r.userId){AJS.trigger("analyticsEvent",{name:"hipchat.presence.user.unknown",data:{userId:r.userId}})}}catch(s){}}})})}})})(AJS.$);
}catch(e){WRMCB(e)};
;
try {
...
Confluence.Templates.HipChat.Discovery.spaceIntegrationDialog = function(opt_data, opt_ignored) {
  return '<h2>' + soy.$$escapeHtml('\u53d1\u9001\u6d88\u606f\u5230 HipChat \u623f\u95f4') + '</h2><p>' + soy.$$escapeHtml('\u5c06\u65b0\u9875\u9762\u3001\u535a\u5ba2\u6216\u7a7a\u95f4\u66f4\u6539\u7684\u901a\u77e5\u76f4\u63a5\u53d1\u9001\u5230 HipChat \u623f\u95f4\u3002') + '</p><br/><button class="aui-button" id="hipchat-integration-discovery-open">' + soy.$$escapeHtml('\u6dfb\u52a0 HipChat \u901a\u77e5') + '</button><a href="#" style="padding-left: 20px" id="hipchat-integration-discovery-dismiss">' + soy.$$escapeHtml('\u4e0d\u662f\u73b0\u5728') + '</a>';
};
if (goog.DEBUG) {
...
JIRA.Template.Util.Issue.Status.issueStatusResolver = function(opt_data, opt_ignored) {
  return '' + ((! opt_data.issueStatus) ? '<span class="aui-icon aui-icon-small aui-iconfont-help jira-issue-status-render-error" title="' + soy.$$escapeHtml('\u672a\u63d0\u4f9b\u95ee\u9898\u72b6\u6001\u4fe1\u606f') + '"></span>' : (opt_data.issueStatus.statusCategory) ? JIRA.Template.Util.Issue.Status.issueStatus(opt_data) : JIRA.Template.Util.Issue.Status.iconStatus({name: opt_data.issueStatus.name, iconUrl: opt_data.issueStatus.iconUrl, description: opt_data.issueStatus.description, isCompact: opt_data.isCompact}));
};
if (goog.DEBUG) {
...
Confluence.Templates.Metadata.Jira.metadata = function(opt_data, opt_ignored) {
  var output = '<div id="jira-metadata-dialog" class="rendered-content"><h2 class="title">' + soy.$$escapeHtml('JIRA \u94fe\u63a5') + '</h2><div class="items-section">';
  ...
  for (var groupIndex6 = 0; groupIndex6 < groupListLen6; groupIndex6++) {
    ...
    if (groupData6.items.length) {
      switch (groupData6.type) {
        case 'ISSUES':
          output += Confluence.Templates.Metadata.Jira.renderGroup({items: groupData6.items, headingText: '\u95ee\u9898', type: groupData6.type, links: groupData6.links});
          break;
        case 'SPRINTS':
          output += Confluence.Templates.Metadata.Jira.renderGroup({items: groupData6.items, headingText: 'Sprints', type: groupData6.type, links: groupData6.links});
          break;
        case 'VERSIONS':
          output += Confluence.Templates.Metadata.Jira.renderGroup({items: groupData6.items, headingText: '\u7248\u672c', type: groupData6.type, links: groupData6.links});
          break;
        case 'EPICS':
...
Confluence.Templates.Metadata.Jira.featureDiscovery = function(opt_data, opt_ignored) {
  return '<div id="jira-metadata-feature-discovery"><h2>' + soy.$$escapeHtml('\u5728\u6b64\u67e5\u770b\u76f8\u5173\u7684Jira\u6761\u76ee') + '</h2><p>' + soy.$$escapeHtml('\u73b0\u5728\u80fd\u591f\u67e5\u770b\u4e0e\u6b64\u9875\u9762\u76f8\u5173\u7684Epic\u3001Sprint\u3001\u7248\u672c\u548c\u95ee\u9898\u3002') + '</p><div class="aui-toolbar2" role="toolbar"><div class="aui-toolbar2-inner">' + aui.buttons.button({text: '\u663e\u793a\u81ea\u5df1', extraClasses: 'showme'}) + aui.buttons.button({text: '\u4e0d\u8981\u518d\u663e\u793a', type: 'link', extraClasses: 'close'}) + '</div></div></div>';
};
if (goog.DEBUG) {
...
Confluence.Templates.Metadata.Jira.nometadata = function(opt_data, opt_ignored) {
  return '<div id="jira-metadata-dialog" class="rendered-content">' + aui.message.warning({content: '<p>' + soy.$$escapeHtml('\u65e0\u6cd5\u663e\u793a JIRA \u94fe\u63a5\u3002\u53ef\u80fd\u60a8\u6ca1\u6709\u6b63\u786e\u7684 JIRA \u6743\u9650\uff0c\u4e5f\u53ef\u80fd\u662f\u94fe\u63a5\u5df2\u88ab\u5220\u9664\u3002') + '</p>'}) + '</div>';
};
if (goog.DEBUG) {
...
Confluence.Templates.Metadata.Jira.renderAuthPrompts = function(opt_data, opt_ignored) {
  ...
  if (opt_data.appLinks.length) {
    ...
    if (opt_data.appLinks.length == 1) {
      ...
      param66 += '<p>' + soy.$$filterNoAutoescape(AJS.format('{0}\u767b\u5f55 \x26amp; \u5141\u8bb8{1}\u4ece{2}\u68c0\u7d22\u6570\u636e','<a class="jira-metadata-auth-link" href="#" data-href="' + appLink__soy69.authorisationUrl + '">','</a>',appLink__soy69.htmlSafeName)) + '</p>';
    } else {
      param66 += '<p>' + soy.$$escapeHtml('\u5141\u8bb8\u4ece\u4e0b\u6765\u5b9e\u4f8b\u4e2d\u68c0\u7d22\u6570\u636e:') + '</p>';
...
Confluence.Templates.Metadata.Jira.renderGroup = function(opt_data, opt_ignored) {
  ...
  for (var linkIndex130 = 0; linkIndex130 < linkListLen130; linkIndex130++) {
    ...
    output += '<li class="jira-metadata-item"><a href="' + soy.$$escapeHtml("") + '/plugins/servlet/jira-metadata/redirect?u=' + soy.$$escapeUri(linkData130.url) + '&t=' + soy.$$escapeHtml(opt_data.type) + '&more">' + soy.$$escapeHtml(AJS.format('\u5728 {1}\u4e2d\uff0c\u67e5\u770b\u66f4\u591a\u7684{0}',linkData130.numItems,linkData130.appName)) + '</a></li>';
  }
  output += '</ul></div>';
  return output;
};
...
Confluence.Templates.Metadata.Jira.loadingMetadata = function(opt_data, opt_ignored) {
  return '<div id="jira-metadata-dialog"><h2 class="title">' + soy.$$escapeHtml('JIRA \u94fe\u63a5') + '</h2><div class="spinner-container"><div class="spinner"></div></div></div>';
};
if (goog.DEBUG) {
...
Confluence.Templates.Metadata.Jira.renderJiraErrors = function(opt_data, opt_ignored) {
  ...
  if (opt_data.errors.length == 1) {
    ...
    output += aui.message.warning({content: '<p>' + soy.$$escapeHtml('\u65e0\u6cd5\u68c0\u7d22 JIRA \u5143\u6570\u636e\u3002') + ' ' + soy.$$escapeHtml(error__soy150.errorMessage) + '</p>'});
  } else if (opt_data.errors.length > 1) {
    var param159 = '<p>' + soy.$$escapeHtml('\u4e0d\u80fd\u83b7\u53d6Jira\u5143\u6570\u636e\u4fe1\u606f\uff0c\u53d1\u751f\u4e86\u4ee5\u4e0b\u9519\u8bef:') + '</p><ul>';
...
Confluence.Templates.Metadata.Jira.unknownError = function(opt_data, opt_ignored) {
  return '<div id="jira-metadata-dialog" class="rendered-content">' + aui.message.warning({content: '<p>' + soy.$$escapeHtml('\u65e0\u6cd5\u68c0\u7d22 JIRA \u5143\u6570\u636e\u3002\u65e0\u6cd5\u8fde\u63a5\u5230 Confluence') + '</p>'}) + '</div>';
};
if (goog.DEBUG) {
...
Confluence.Templates.Sidebar.renderSpaceToolsSection = function(opt_data, opt_ignored) {
  ...
  output += ((opt_data.hasConfigurePermission) ? '<div data-label="' + soy.$$escapeHtml('\u914d\u7f6e\u4fa7\u8fb9\u680f') + '" data-class="configure-sidebar" data-href="">' + soy.$$escapeHtml('\u914d\u7f6e\u4fa7\u8fb9\u680f') + '</div>' : '') + '</div>' + aui.dropdown2.trigger({menu: {id: 'space-tools-menu'}, id: 'space-tools-menu-trigger', tagName: 'button', extraClasses: 'aui-button aui-button-subtle tipsy-enabled' + ((opt_data.currentlyViewed) ? ' current-item' : ''), content: aui.icons.icon({useIconFont: true, icon: 'configure', accessibilityText: '\u8bbe\u7f6e'}) + '<span class="aui-button-label">' + soy.$$escapeHtml('\u7a7a\u95f4\u7ba1\u7406') + '</span>'}) + aui.dropdown2.contents({id: 'space-tools-menu', extraClasses: 'aui-style-default space-tools-dropdown', extraAttributes: {'data-aui-alignment': 'top left'}}) + '<a class="expand-collapse-trigger"></a></div>';
  return output;
};
if (goog.DEBUG) {
...
Confluence.Templates.Sidebar.configure = function(opt_data, opt_ignored) {
  return '<div class="acs-nav-sections"><table id="acs-nav-list-main" class="acs-nav-list"></table><div class="acs-nav-list-quick-section' + ((opt_data.quickLinksState == 'hide') ? ' hidden-section' : '') + '"><div class="quick-links-header"><h5>' + soy.$$escapeHtml('\u7a7a\u95f4\u5feb\u6377\u94fe\u63a5') + '</h5><a href="#" class="aui-icon aui-icon-small toggle-link" data-tooltip="' + soy.$$escapeHtml('\u663e\u793a/\u9690\u85cf\u7a7a\u95f4\u5feb\u6377\u94fe\u63a5') + '"/></div><table id="acs-nav-list-quick" class="acs-nav-list"></table><p class="tip">' + soy.$$escapeHtml('\u70b9\u51fb\u201c\u589e\u52a0\u94fe\u63a5\u201d\u6765\u5411\u4fa7\u8fb9\u680f\u4e2d\u589e\u52a0\u94fe\u63a5\u3002') + '</p><a class="acs-add-link" href="#"><span class="icon"></span><span class="label">' + soy.$$escapeHtml('\u589e\u52a0\u94fe\u63a5') + '</span></a></div>' + ((opt_data.hasSidebarCustomisation) ? '<p class="tip">' + soy.$$filterNoAutoescape(AJS.format('\u4f60\u53ef\u4ee5\u7ee7\u7eed\u5728\u7a7a\u95f4\u7ba1\u7406\u4e2d\u81ea\u5b9a\u4e49\u4fa7\u8fb9\u680f\u3002 \x3ca href\x3d\x22{0}\x22 class\x3d\x22{1}\x22\x3e\u524d\u5f80\u7a7a\u95f4\u7ba1\u7406\x3c/a\x3e\u3002',opt_data.customContentAdminLink,'custom-sidebar-tip')) + '</p>' + Confluence.Templates.Sidebar.renderCustomContent(opt_data) : '') + '<div class="acs-nav-list-page-tree-section' + ((opt_data.pageTreeState == 'hide') ? ' hidden-section' : '') + '"><div class="page-tree-header"><h5>' + soy.$$escapeHtml('\u5bfc\u822a\u663e\u793a\u9009\u9879') + '</h5><a href="#" class="aui-icon aui-icon-small toggle-link" data-tooltip="' + soy.$$escapeHtml('\u9690\u85cf\uff0f\u663e\u793a \u5bfc\u822a\u663e\u793a\u9009\u9879') + '"/></div><form class="aui page-tree-options"><div class="radio"><input ' + ((opt_data.pageTreeState == 'hide') ? 'disabled ' : '') + ' class="radio acs-nav-type" type="radio" name="nav-type" value="pages" id="nav-type-pages" ' + ((! opt_data.pageTree) ? 'checked' : '') + '><label for="nav-type-pages">' + soy.$$escapeHtml('\u5b50\u9875\u9762') + '</label></div><div class="radio"><input ' + ((opt_data.pageTreeState == 'hide') ? 'disabled ' : '') + ' class="radio acs-nav-type" type="radio" name="nav-type" value="page-tree" id="nav-type-tree" ' + ((opt_data.pageTree) ? 'checked' : '') + '><label for="nav-type-tree">' + soy.$$escapeHtml('\u9875\u9762\u6811\u7ed3\u6784') + '</label></div></form></div><button class="aui-style aui-button acs-done-link">' + soy.$$escapeHtml('\u5b8c\u6210') + '</button></div>';
};
if (goog.DEBUG) {
...
Confluence.Templates.User.logo = function(opt_data, opt_ignored) {
  return '' + ((opt_data.profilePictureInfo['default'] && opt_data.username == opt_data.currentUsername) ? '<a ' + ((opt_data.canView) ? ' ' + ((! opt_data.disableUserHover) ? 'class="userLogoLink"' : '') + ' data-username="' + soy.$$escapeHtml(opt_data.username) + '"' : '') + ' href="' + soy.$$escapeHtml("") + '/users/profile/editmyprofilepicture.action" title="' + soy.$$escapeHtml('\u6dfb\u52a0\u5934\u50cf') + '"><img class="userLogo logo defaultLogo" src="' + soy.$$escapeHtml("/s/zh_CN/7502/a025d1ea507f6473e7dfa3a92b4a4cc699e1e6ac/_") + '/images/icons/profilepics/add_profile_pic.png" alt="' + soy.$$escapeHtml('\u7528\u6237\u56fe\u6807') + ': ' + soy.$$escapeHtml('\u6dfb\u52a0\u5934\u50cf') + '"></a>' : (opt_data.profilePictureInfo.anonymous) ? '<img class="userLogo logo anonymous" src="' + soy.$$escapeHtml("/s/zh_CN/7502/a025d1ea507f6473e7dfa3a92b4a4cc699e1e6ac/_") + '/images/icons/profilepics/anonymous.png" alt="' + soy.$$escapeHtml('\u7528\u6237\u56fe\u6807') + ': ' + soy.$$escapeHtml('\u533f\u540d') + '" title="' + soy.$$escapeHtml('\u533f\u540d') + '">' : (opt_data.canView) ? '<a ' + ((! opt_data.disableUserHover) ? 'class="userLogoLink"' : '') + ' data-username="' + soy.$$escapeHtml(opt_data.username) + '" href="' + Confluence.Templates.User.userLinkUrl(opt_data) + '"><img class="userLogo logo" src="' + soy.$$escapeHtml(opt_data.profilePictureInfo.uriReference) + '" alt="' + soy.$$escapeHtml('\u7528\u6237\u56fe\u6807') + ': ' + soy.$$escapeHtml(opt_data.username) + '" title="' + soy.$$escapeHtml(opt_data.username) + '"></a>' : '<img class="userLogo logo anonymous" src="' + soy.$$escapeHtml("/s/zh_CN/7502/a025d1ea507f6473e7dfa3a92b4a4cc699e1e6ac/_") + '/images/icons/profilepics/anonymous.png" alt="' + soy.$$escapeHtml('\u7528\u6237\u56fe\u6807') + ': ' + soy.$$escapeHtml(opt_data.username) + '" title="' + soy.$$escapeHtml(opt_data.username) + '">');
};
if (goog.DEBUG) {
...
Confluence.Templates.Captcha.form = function(opt_data, opt_ignored) {
  var output = '<div class="captcha field-group"><label id="captcha-response-label" for="captcha-response"><span class="assistive">' + soy.$$escapeHtml('\u5982\u679c\u60a8\u65e0\u6cd5\u4f7f\u7528\u6b64 CAPTCHA \u8bf7\x3ca href\x3d\x22administrators.action\x22 tabindex\x3d\x225\x22\x3e\u8054\u7cfb\u60a8\u7684\u7ba1\u7406\u5458\x3c/a\x3e\u5bfb\u6c42\u5e2e\u52a9\u3002') + '</span></label>' + Confluence.Templates.Captcha.image(opt_data) + '<input type="text" id="captcha-response" name="captchaResponse" value="" class="text" placeholder="' + soy.$$escapeHtml('\u8f93\u5165\u4e0a\u9762\u7684\u6587\u5b57') + '">';
...
Confluence.Templates.PageBanner.draftStatusDiscovery = function(opt_data, opt_ignored) {
  return '<aui-inline-dialog id="' + soy.$$escapeHtml(opt_data.elementId) + '" alignment="bottom left" open><p><strong>' + soy.$$escapeHtml('\u6ca1\u6709\u53d1\u5e03\uff1f') + '</strong></p><p>' + soy.$$filterNoAutoescape(AJS.format('\u90fd\u597d\u4e86\uff0c\u6211\u4eec\u5df2\u4fdd\u5b58\u4e86\u60a8\u7684\u66f4\u6539\uff01 \u968f\u65f6\u5728\x3ca href\x3d\x22{0}\x22\x3e\u6700\u8fd1\u7684\u5de5\u4f5c\x3c/a\x3e\u4e2d\u627e\u5230\u5b83\u4eec\u3002\u53ea\u9700\u4fdd\u6301\u7f16\u8f91\uff0c\u51c6\u5907\u5c31\u7eea\u540e\u53d1\u5e03\u3002',opt_data.linkToMyWork)) + '</p><p><a class="aui-button">' + soy.$$escapeHtml('\u597d\uff0c\u660e\u767d\u4e86!') + '</a></p></aui-inline-dialog>';
};
if (goog.DEBUG) {
...
define("confluence/page-message","ajs jquery confluence/meta window confluence/api/browser confluence-editor/editor/page-editor-message".split(" "),function(a,h,d,f,i,j){var e={},g=new i(f.navigator.userAgent);e._getQueryString=function(){return f.location.search};e.displayPageMessage=function(){var c=e._getQueryString(),b=d.get("editing-user");if(c.indexOf("editingLocked")!==-1&&b)a.MessageHandler.flag({type:"info",title:"\u65e0\u6cd5\u7f16\u8f91",body:a.format("\u534f\u540c\u7f16\u8f91\u76ee\u524d\u5904\u4e8e\u79bb\u7ebf\u72b6\u6001\uff0c\u5e76\u4e14 {0} \u6b63\u5728\u7f16\u8f91\u8fd9\u4e2a\u9875\u9762\u3002\u5728\u51e0\u5206\u949f\u540e\u518d\u8bd5\u4e00\u6b21\u3002",
a.escapeHtml(b)),close:"manual"});else if(c.indexOf("editingFailed")!==-1)a.MessageHandler.flag({type:"info",title:"\u65e0\u6cd5\u7f16\u8f91",body:"\u7f16\u8f91\u73b0\u5728\u4e0d\u53ef\u7528\u3002\u51e0\u5206\u949f\u540e\u518d\u8bd5\u4e00\u6b21\u3002",close:"manual"});else if(c.indexOf("userLimitReached")!==-1){j.handleMessage("collab.edit.user.limit.reached",{type:"warning",title:"\u60a8\u73b0\u5728\u4e0d\u80fd\u7f16\u8f91\u8fd9\u4e2a\u9875\u9762",message:"\u003cp\u003e\u8fd9\u4e2a\u9875\u9762\u592a\u53d7\u6b22\u8fce\u4e86\uff0c\u60a8\u5df2\u7ecf\u8fbe\u5230\u540c\u65f6\u7f16\u8f91\u8005\u7684\u6700\u5927\u6570\u91cf\u3002\u003c/p\u003e\u003cp\u003e\u7b49\u5b83\u4e0d\u90a3\u4e48\u5fd9\u65f6\u518d\u6b21\u5c1d\u8bd5\u3002\u003c/p\u003e",close:"manual"});a.Confluence.Analytics.publish("collab.edit.user.limit.reached",
{browserName:g.friendlyName(),browserVersion:g.version(),pageId:d.get("page-id"),editMode:"slow",numEditors:d.get("max-number-editors")})}else if(c.indexOf("spaceEditingRestriction")!==-1){b=d.get("space-key");c=d.get("content-type")==="blogpost"?"\u60a8\u4e0d\u80fd\u7f16\u8f91\u6b64\u7a7a\u95f4\u535a\u5ba2":"\u60a8\u4e0d\u80fd\u7f16\u8f91\u6b64\u7a7a\u95f4\u9875\u9762";b=d.get("context-path")+"/spaces/viewspacesummary.action?key="+encodeURIComponent(b);b=d.get("content-type")==="blogpost"?a.format("\u8bf7\u6c42 {0}\u7a7a\u95f4\u7ba1\u7406\u5458{1} \u6216\u60a8\u7684\u9080\u8bf7\u4eba\u6388\u4e88\u60a8\u5728\u6b64\u7a7a\u95f4\u201c\u6dfb\u52a0\u535a\u5ba2\u201d\u7684\u6743\u9650\u3002",
'<a href="'+b+'">',"</a>"):a.format("\u8bf7\u6c42{0}\u7a7a\u95f4\u7ba1\u7406\u5458{1}\u6216\u60a8\u7684\u9080\u8bf7\u4eba\u6388\u4e88\u60a8\u5728\u6b64\u7a7a\u95f4\u201c\u6dfb\u52a0\u9875\u9762\u201d\u7684\u6743\u9650\u3002",'<a href="'+b+'">',"</a>");c=a.MessageHandler.flag({type:"info",title:c,body:b,close:"manual"});h(c).addClass("spaceEditingRestriction")}};return e});require("confluence/module-exporter").safeRequire("confluence/page-message",function(a){require("ajs").toInit(a.displayPageMessage)});
}catch(e){WRMCB(e)};
;
try {
...
define("vfm/view-file-macro-utils",[],function(){var a={DEFAULT_HEIGHT:"250",DEFAULT_HEIGHT_IN_COMMENT:"150",THUMBNAIL_STATUS_IN_PROGRESS:202,THUMBNAIL_STATUS_CONVERTED:200,THUMBNAIL_STATUS_ERROR:415,THUMBNAIL_STATUS_BUSY:429,THUMBNAIL_POLLING_PERIOD:1000,THUMBNAIL_POLLING_BACKOFF_RATIO:1.25,MAP_NICE_TYPE_TO_TEXT:{"pdf document":"PDF","word document":"\u6587\u6863","excel spreadsheet":"\u7535\u5b50\u8868\u683c","powerpoint presentation":"\u6f14\u793a","generic file":"\u6587\u4ef6"},getFileNameFromUrl:function(b){if(!b){return""}var c=b.indexOf("#");c=(c>=0)?c:b.length;b=b.substring(0,c);c=b.indexOf("?");c=(c>=0)?c:b.length;b=b.substring(0,c);c=b.lastIndexOf("/");b=b.substring(c+1,b.length);return decodeURIComponent(b)},isSupportPointerEvents:function(){var b=document.createElement("x");b.style.cssText="pointer-events:auto";return b.style.pointerEvents==="auto"},getParameterByName:function(d,c){var e=d.indexOf("#");if(e>=0){d=d.substring(0,e)}var b=new RegExp(c+"=([^&]*)","i").exec(d);return b?decodeURIComponent(b[1]):null},addParamsToUrl:function(b,h){var f="";if(b.indexOf("?")===-1){f="?"}else{f="&"}var e=Object.keys(h);for(var d=0;d<e.length;d++){var c=e[d];var g=h[c];if(d>0){f+="&"}f+=c+"="+g}return b+f},getFileTypeTextFromNiceType:function(b){b=b?b.toLowerCase():"";return this.MAP_NICE_TYPE_TO_TEXT[b]?this.MAP_NICE_TYPE_TO_TEXT[b]:b}};return a});
}catch(e){WRMCB(e)};
;
try {
...
b)});return a}function r(a,e){if(e)switch(e.status){case 423:var f=JSON.parse(e.responseText).user;n();b.MessageHandler.flag({type:"info",title:"\u65e0\u6cd5\u7f16\u8f91",body:b.format("\u534f\u540c\u7f16\u8f91\u76ee\u524d\u5904\u4e8e\u79bb\u7ebf\u72b6\u6001\uff0c\u5e76\u4e14 {0} \u6b63\u5728\u7f16\u8f91\u8fd9\u4e2a\u9875\u9762\u3002\u5728\u51e0\u5206\u949f\u540e\u518d\u8bd5\u4e00\u6b21\u3002",b.escapeHtml(f)),close:"manual"});return;case 412:n();x.handleMessage("collab.edit.user.limit.reached",{type:"warning",title:"\u60a8\u73b0\u5728\u4e0d\u80fd\u7f16\u8f91\u8fd9\u4e2a\u9875\u9762",message:"\u003cp\u003e\u8fd9\u4e2a\u9875\u9762\u592a\u53d7\u6b22\u8fce\u4e86\uff0c\u60a8\u5df2\u7ecf\u8fbe\u5230\u540c\u65f6\u7f16\u8f91\u8005\u7684\u6700\u5927\u6570\u91cf\u3002\u003c/p\u003e\u003cp\u003e\u7b49\u5b83\u4e0d\u90a3\u4e48\u5fd9\u65f6\u518d\u6b21\u5c1d\u8bd5\u3002\u003c/p\u003e",close:"manual"});v.publish("collab.edit.user.limit.reached",
...
Confluence.Templates.Comments.userLogo = function(opt_data, opt_ignored) {
  return '<p class="comment-user-logo">' + ((opt_data.userInfo.userName == null) ? '<img class="userLogo logo anonymous" src="' + soy.$$escapeHtml("/s/zh_CN/7502/a025d1ea507f6473e7dfa3a92b4a4cc699e1e6ac/_") + '/images/icons/profilepics/anonymous.png" alt="' + soy.$$escapeHtml('\u7528\u6237\u56fe\u6807') + ': ' + soy.$$escapeHtml('\u533f\u540d') + '" title="' + soy.$$escapeHtml('\u533f\u540d') + '">' : (opt_data.userInfo.profilePicture.isDefault) ? '<a class="userLogoLink" data-username="' + soy.$$escapeHtml(opt_data.userInfo.userName) + '" href="' + soy.$$escapeHtml("") + '/users/profile/editmyprofilepicture.action" title="' + soy.$$escapeHtml('\u6dfb\u52a0\u5934\u50cf') + '"><img class="userLogo logo defaultLogo" src="' + soy.$$escapeHtml("/s/zh_CN/7502/a025d1ea507f6473e7dfa3a92b4a4cc699e1e6ac/_") + '/images/icons/profilepics/add_profile_pic.png" alt="' + soy.$$escapeHtml('\u7528\u6237\u56fe\u6807') + ': ' + soy.$$escapeHtml('\u6dfb\u52a0\u5934\u50cf') + '"></a>' : '<a class="userLogoLink" data-username="' + soy.$$escapeHtml(opt_data.userInfo.userName) + '" href="' + Confluence.Templates.User.userLinkUrl({username: opt_data.userInfo.userName}) + '"><img class="userLogo logo" src="' + soy.$$escapeHtml(opt_data.userInfo.profilePicture.path) + '" alt="' + soy.$$escapeHtml('\u7528\u6237\u56fe\u6807') + ': ' + soy.$$escapeHtml(opt_data.userInfo.userName) + '" title="' + soy.$$escapeHtml(opt_data.userInfo.userName) + '"></a>') + '</p>';
};
if (goog.DEBUG) {
...
define("confluence-quick-edit/handlers/comment","ajs confluence/legacy jquery aui/flag confluence-quick-edit/util confluence-editor/editor/page-editor-message".split(" "),function(a,f,d,m,k,g){function l(a,c){var h=a.match(RegExp("[?&]"+c+"=(\\d+)"));return h&&h.length>1?parseInt(h[1]):0}d(function(){a.AppLinksInitialisationBinder=function(b){a.bind("init.rte",b)}});var e={timeout:8E3,showLoadingEditorErrorMessage:function(){a.trigger("rte-quick-comment-loading-failed");m({type:"error",title:"\u9519\u8bef",
...
var c;if(b&&b.search(/captcha/i)!==-1){c="\u8f93\u5165\u7684\u6587\u5b57\u4e0e\u56fe\u7247\u4e2d\u7684\u6587\u5b57\u4e0d\u4e00\u81f4\u3002";g.closeMessages(["captcha-response-failed"]);g.handleMessage("captcha-response-failed",{type:"error",message:c})}else{c="\u4fdd\u5b58\u8bc4\u8bba\u5931\u8d25\u3002\u8bf7\u7a0d\u540e\u518d\u8bd5\u3002\u6216\u68c0\u67e5\u5185\u5bb9\u662f\u5426\u6709\u7279\u6b8a\u5b57\u7b26/emoji\u8868\u60c5\u3002";g.closeMessages(["server-offline"]);g.handleMessage("server-offline",{type:"error",message:c})}a.logError("Error saving comment",b)},cancelComment:function(){a.Rte.Content.editorResetContentChanged();return a.Confluence.QuickEdit.deactivateEditor()},
...
require(["ajs","confluence/meta","confluence/share-page/service/share-page"],function(b,c,d){var e=c.get("content-type")==="page"?"\u5206\u4eab\u6b64\u9875\u9762":"\u5206\u4eab\u6b64\u535a\u5ba2";var a=c.get("content-type")==="page"?"\u67e5\u770b\u6b64\u9875\u9762":"\u67e5\u770b\u6b64\u535a\u5ba2";b.toInit(function(h){var g="#shareContentLink";var f=h(g);d.initDialog(g,"shareContentPopup",{},{heading:e,notePlaceholder:a,link:function(){return h('link[rel="shortlink"]').prop("href")},entityId:function(){return c.get("page-id")},restriction:function(){return require("confluence/share-page/fetch/content-restrictions")(c.get("content-id")).pipe(function(i){var k=i.read.restrictions.user.size||i.read.restrictions.group.size||i.update.restrictions.user.size||i.update.restrictions.group.size;var j={};if(k){j.type="restrict";j.message="\u6b64\u9875\u9762\u7684\u9650\u5236\u53ef\u4ee5\u9632\u6b62\u6210\u5458\u67e5\u770b\u6216\u7f16\u8f91\u3002"}return j})},copyOption:"share",shareType:"view",contentType:c.get("content-type"),errorText:"\u53d1\u751f\u610f\u5916\u9519\u8bef\u3002\u8bf7\u91cd\u8bd5\u3002",beforeLoad:function(){f.find(".aui-icon").css("visibility","hidden");f.parent().spin({left:"10px"})},afterLoad:function(){f.find(".aui-icon").css("visibility","visible");f.parent().spinStop()},onHide:function(){h(".dashboard-actions .explanation").hide()}})})});
}catch(e){WRMCB(e)};
;
try {
...
;
try {
/* module-key = 'cz.morosystems.atlassian.plugin.easymind:namymap-blueprint-resource', location = 'templates/soy/blueprint.soy' */
// This file was automatically generated from blueprint.soy.
// Please don't edit this file by hand.

/**
 * @fileoverview Templates in namespace namymap.blueprint.
 */

if (typeof namymap == 'undefined') { var namymap = {}; }
if (typeof namymap.blueprint == 'undefined') { namymap.blueprint = {}; }


namymap.blueprint.ChooseMindMap = function(opt_data, opt_ignored) {
  return '<form action="#" method="post" id="blueprint-form" class="aui"><div class="field-group"><label for=templates>' + soy.$$escapeHtml('Select a template:') + '</label><select class="select" id=templates name=templates></select><div class="error"></div></div></form>';
};
if (goog.DEBUG) {
  namymap.blueprint.ChooseMindMap.soyTemplateName = 'namymap.blueprint.ChooseMindMap';
}

}catch(e){WRMCB(e)};
;
try {
/* module-key = 'cz.morosystems.atlassian.plugin.easymind:namymap-blueprint-resource', location = 'js/blueprint.js' */
AJS.toInit(function($) {
	
	function submitNamymap(e, state) {
	...
	function postrenderNamymap(e, state) {
		var select = document.getElementById("templates");
		var templates = null;
		
		var my_url = AJS.format("{0}/plugins/servlet/namymaptemplate", AJS.Confluence.getContextPath());
		jQuery.ajax({
			type: "POST",
			url:my_url,
			data: { templateAction: "template_list" },
			success: function(result) {
				
				if (result){
					templates = JSON.parse(result);
				}
				//console.debug("Template list was loaded: " + result);
			}, error: function(result) {
				//console.debug("Load template list failed");
			}, async: false,
		});

		var optionNewDoc = document.createElement("option");
		optionNewDoc.text = "New Document";
		select.add(optionNewDoc, undefined);
		
		if (templates != null) {
			for (i = 0; i < templates.length; i++) {
				var option = document.createElement("option");
				option.text = templates[i].name;
				option.value = templates[i].key;
	...
	Confluence.Blueprint.setWizard('cz.morosystems.atlassian.plugin.easymind:blueprint-item', function(wizard) {
        wizard.on("submit.namymapTemplate", submitNamymap);
        wizard.on("post-render.namymapTemplate", postrenderNamymap);
    });
});
